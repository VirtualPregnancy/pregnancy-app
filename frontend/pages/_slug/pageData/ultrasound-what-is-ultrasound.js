export default {
  ...
  contentSections: [
    ...
    },
    {
      ...
      icon: "mdi-water-plus",
      iconColor: "var(--v-primary-base)",
      content:"A special type of ultrasound called Doppler ultrasound is used to assess how maternal blood is flowing through the uterus to the placenta, and how blood is flowing between the fetus and the placenta. See more at <a href='/ultrasound-doppler'>Doppler ultrasound in pregnancy</a>."
